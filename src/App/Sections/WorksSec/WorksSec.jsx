        ...
        <div className="row justify-content-center">
          {works.map((project, index) => (
            <div key={index} className="col-lg-4 col-md-6 col-10 py-2">
              ...
              >
                {/* Carousel avec background-image */}
                <div
                  id={`carousel-${index}`}
                    ...
                    {project.imgs.map((img, imgIndex) => (
                      ...
                      >
                        <div
                          ...
                          style={{
                            height: "200px", // ou toute autre hauteur
                ...
                <div className="card-body d-flex flex-column">
                  <div>
                    <span className="type-work">Application Web</span>
                  </div>
                  ...
                  <p className="card-text" style={{ flexGrow: 1 }}></p>
